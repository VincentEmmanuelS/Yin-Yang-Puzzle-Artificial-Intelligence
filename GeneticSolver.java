 ...
 public class GeneticSolver {
     ...
     private List<Chromosome> evolve(List<Chromosome> population) {
         ...
         for (int i = 0; i < GeneticAlgorithmYinYang.POPULATION_SIZE; i++) {
             ...
             // Memilih dua orang tua secara acak
             Chromosome parent1 = selectParent(population);
             Chromosome parent2 = selectParent(population);

             // Melakukan crossover untuk menghasilkan keturunan
             Chromosome offspring = parent1.crossover(parent2);

             // Melakukan mutasi pada keturunan
             offspring.mutate();
             newPopulation.add(offspring); // Menambahkan keturunan ke populasi baru
         }
         return newPopulation; // Mengembalikan populasi baru
     }
     ...
     private Chromosome getBestChromosome(List<Chromosome> population) {
         ...
         // Mengembalikan kromosom dengan fitness terkecil (terbaik)
